...
namespace ApacheOrcDotNet.ColumnTypes
{
    ...
    {
        private static readonly DateTime _orcEpoch = new DateTime(2015, 1, 1, 0, 0, 0, DateTimeKind.Utc);
        ...
        public TimestampWriter(bool isNullable, bool shouldAlignEncodedValues, OrcCompressedBufferFactory bufferFactory,
            uint columnId)
        {
        ...
        private long GetValues(DateTime dateTime, out long millisecondsSinceUnixEpoch, out long fraction)
        {
        ...
        private byte RemoveZeros(int nanoseconds, out int scaledNanoseconds)
        {
