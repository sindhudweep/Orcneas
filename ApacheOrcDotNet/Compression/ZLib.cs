...
namespace ApacheOrcDotNet.Compression
{
    ...
    {
        private readonly bool _areCompressing;
        private readonly Stream _deflateStream;
        ...
        public ZLibStream(CompressionStrategy strategy, Stream outputStream)
        {
            ...
            switch (strategy)
            {
                case CompressionStrategy.Size:
                    compressionLevel = CompressionLevel.Optimal;
                    break;
                case CompressionStrategy.Speed:
        ...
        public override bool CanRead => !_areCompressing;
        public override bool CanSeek => false;
        public override bool CanWrite => _areCompressing;
