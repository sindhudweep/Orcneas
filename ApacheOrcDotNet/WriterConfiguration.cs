namespace ApacheOrcDotNet
{
    ...
    public class WriterConfiguration
    {
        ...
        /// <summary>
        ///     Default precision (total number of digits before and after the decimal place) to use for decimals with
        ///     un-configured precision
        ...
        ///     The default, 6, allows for number to be stored from -999,999,999,999.999999 to 999,999,999,999.999999, i.e.
